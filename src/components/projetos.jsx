...
export default function Projetos() {
  const [projeto, setProjeto] = useState(
    [
      ...
      { Imagem: Contador,titulo:"Contador de Estrelas", descricao:"O Contador foi uma página simples com a temática livre. Minha primeira página em React, o objetivo dela foi criar dois botões, um para incluir valore s de 1 em 1 e outro para subtrair. Você pode visitar minha página em:", html: html5, css: css3, JS: js, reacts: reacts, link:"https://giulianobotelho.github.io/contador_react/", },
      { Imagem: Elden, titulo:"Elden Ring Wiki", descricao:"Esse foi o projeto onde eu mais dediquei tempo e aprendi bastante com ele. Desenvolvi uma página onde eu pudesse contar um pouco da história do jogo, apresentando os chefes principais juntamente com suas 'cutscenes'. Também conta com informações sobre mapas, castelos e personagens. Você pode visitar minha página em:", html: html5, JS: js, reacts: reacts, styles: styles, framer: framer, link:"https://elden-ring-wik-react.vercel.app/", },
      { Imagem: Estacoes, titulo:"Verifique as estações do ano", descricao:"Criei essa página nos meus primeiros passos em JS.  Possui 4 botões e cada um deles você acessa uma pequena apresentação sobre as estações do ano. Aprendi a aplicar condições, eventos de click e um pouco de CSS. Você pode visitar minha página em:", html: html5, css: css3, JS: js, link:"https://giulianobotelho.github.io/Estacoes-do-Ano/", },
      { Imagem: Fantastika, titulo:"Fantastika!", descricao:"Desafio proposto pelo curso Vai na Web. Criar uma página responsiva utilizando display flex. A ideia era criar uma landing page de uma loja de banho e tosa.  Você pode visitar minha página em:", html: html5, css: css3, link:"https://giulianobotelho.github.io/Fantastika/", },
      { Imagem: Finn,  titulo:"Página de login: Finn", descricao:"Criada no início dos estudos de display flex, a página propõe uma tela de login com a temática do Finn. Você pode visitar minha página em:", html: html5, css: css3, link:"https://giulianobotelho.github.io/Finn/", },
      { Imagem: Inverno,  titulo:"Página do Inverno", descricao:"Essa página veio como uma proposta do curso vai na web para aprimorar os conhecimentos em display flex. Posicionamento de texto, imagens ,logo, respeitando a semântica da página dividindo-a em header, main e footer. Você pode visitar minha página em:", html: html5, css: css3, link:"https://giulianobotelho.github.io/Pagina-de-Inverno/", },
      { Imagem: Lamp,  titulo:"Lampada em React", descricao:"Minha primeira aplicação em react. Criar uma lâmpada com dois interruptores ON/OFF. Você pode visitar minha página em:", html: html5, css: css3, reacts: reacts, link:"https://giulianobotelho.github.io/lampada/", },
      { Imagem: Todo,  titulo:"Minha primeira ToDo List", descricao:"Uma lista de tarefas simples feita em react. A ideia proposta era armazenar os dados recebidos pelo input dentro da lista, limitando a um número de 10 tarefas por vez. Você pode visitar minha página em:", html: html5, JS: js, reacts: reacts, styles: styles, link:"https://giulianobotelho.github.io/To-Do-List_React/", }
    ]
  )
  return (
    <>
